...
/* Zonas que se pueden marcar como "molestia/lesión" en el formulario.
   caution en cada ejercicio indica qué zonas exige más ese movimiento. */
const CAUTION_OPTIONS = [
  { value: "rodilla", label: "Rodilla" },
  { value: "hombro", label: "Hombro" },
  { value: "espalda", label: "Espalda baja" },
...
const EXERCISES = {
  pecho: [
    { name: "Press de banca plano con barra", compound: true, pattern: "press_horizontal", caution: ["hombro"],
      tip: "Retrae los omóplatos y planta bien los pies; baja la barra controlada hasta rozar el pecho." },
    { name: "Press inclinado con barra", compound: true, pattern: "press_horizontal", caution: ["hombro"],
    ...
    { name: "Press plano con mancuernas", compound: true, pattern: "press_horizontal", caution: ["hombro"],
      tip: "Mayor rango de movimiento que la barra; baja hasta sentir un buen estiramiento en el pecho." },
    { name: "Press inclinado con mancuernas", compound: true, pattern: "press_horizontal", caution: ["hombro"],
      tip: "Inclina el banco 30-45°; un ángulo mayor le quita trabajo al pecho y se lo da al hombro." },
    { name: "Press en Smith (banco plano)", compound: true, pattern: "press_horizontal", caution: ["hombro"],
    ...
    { name: "Press de pecho en máquina (agarre abierto)", pattern: "press_horizontal", caution: ["hombro"],
    ...
    { name: "Aperturas con mancuernas", pattern: "fly", caution: ["hombro"],
  ...
  espalda: [
    ...
    { name: "Remo con barra", compound: true, pattern: "pull_horizontal", caution: ["espalda"],
      tip: "Espalda neutra y core activado; tira hacia el ombligo, no hacia el pecho." },
    { name: "Remo con mancuerna a una mano", pattern: "pull_horizontal", caution: ["espalda"],
      tip: "Apoya rodilla y mano contraria en el banco; evita rotar el torso al tirar." },
    { name: "Peso muerto convencional", compound: true, pattern: "hinge", caution: ["espalda"],
      tip: "Empuja el piso con los pies y mantén la barra pegada a las piernas todo el recorrido." },
    { name: "Peso muerto rumano", compound: true, pattern: "hinge", caution: ["espalda"],
  ...
  hombro: [
    { name: "Press militar de pie con barra", compound: true, pattern: "press_vertical", caution: ["hombro", "espalda"],
      tip: "No arquees en exceso la zona lumbar; aprieta glúteos y abdomen para estabilizar." },
    { name: "Press militar sentado con barra", compound: true, pattern: "press_vertical", caution: ["hombro"],
      tip: "Espalda apoyada en el banco; empuja la barra en línea recta sobre la cabeza sin arquear el cuello." },
    { name: "Press de hombro en Smith", compound: true, pattern: "press_vertical", caution: ["hombro"],
      tip: "El riel guía el recorrido; enfócate en empujar fuerte y controlar la bajada hasta la altura de la oreja." },
    { name: "Press de hombro en máquina (agarre abierto)", pattern: "press_vertical", caution: ["hombro"],
    ...
    { name: "Press de hombro con mancuernas sentado", compound: true, pattern: "press_vertical", caution: ["hombro"],
      tip: "Baja hasta que el codo quede un poco por debajo del hombro, sin forzar." },
    { name: "Press Arnold", pattern: "press_vertical", caution: ["hombro"],
      tip: "Combina rotación con press para trabajar las tres cabezas del deltoides en un solo movimiento." },
    { name: "Elevaciones laterales con mancuerna", pattern: "raise_lateral", caution: ["hombro"],
  ...
  cuadriceps: [
    { name: "Sentadilla libre con barra (jaula)", compound: true, pattern: "squat", caution: ["rodilla", "espalda"],
      tip: "Rodillas alineadas con la punta de los pies; baja manteniendo la curvatura lumbar natural." },
    { name: "Sentadilla en Smith", compound: true, pattern: "squat", caution: ["rodilla"],
      tip: "El riel fija la trayectoria; adelanta un poco los pies para que la rodilla no se vaya de más al bajar." },
    { name: "Sentadilla hack en máquina", compound: true, pattern: "squat", caution: ["rodilla"],
      tip: "Espalda pegada al respaldo; baja controlado sin despegar los talones de la plataforma." },
    { name: "Sentadilla perfecta (máquina guiada)", compound: true, pattern: "squat", caution: ["rodilla"],
      tip: "El movimiento guiado protege la zona lumbar; concéntrate en empujar con todo el pie." },
    { name: "Sentadilla goblet con mancuerna", compound: true, pattern: "squat", caution: ["rodilla"],
      tip: "Sostén la mancuerna pegada al pecho; te ayuda a mantener el torso más erguido." },
    { name: "Sentadilla búlgara con mancuernas", pattern: "lunge", caution: ["rodilla"],
      tip: "Pie trasero elevado en un banco; concéntrate en la pierna delantera en toda la fase." },
    { name: "Prensa de piernas lineal", compound: true, pattern: "leg_press", caution: ["rodilla"],
      tip: "No bloquees por completo la rodilla al extender; controla siempre el descenso." },
    { name: "Prensa de piernas articulada (45°)", compound: true, pattern: "leg_press", caution: ["rodilla"],
      tip: "El recorrido angulado permite más carga; mantén la zona lumbar pegada al respaldo sin despegarla." },
    { name: "Zancadas con mancuernas", pattern: "lunge", caution: ["rodilla"],
      tip: "Paso amplio, baja la rodilla trasera casi hasta rozar el piso sin golpearlo." },
    { name: "Extensión de cuádriceps en máquina", pattern: "leg_extension", caution: ["rodilla"],
      tip: "Controla la bajada; no dejes caer el peso de golpe." },
    { name: "Sentadilla con salto", impact: "high", pattern: "squat", caution: ["rodilla"],
      tip: "Aterriza suave flexionando la rodilla para absorber el impacto." }
  ],

  femoral: [
    { name: "Peso muerto rumano con barra", compound: true, sub: "femoral_compound", pattern: "hinge", caution: ["espalda"],
      tip: "La barra rueda pegada a las piernas; la bisagra ocurre en la cadera, no en la zona lumbar." },
    { name: "Peso muerto rumano con mancuernas", compound: true, sub: "femoral_compound", pattern: "hinge", caution: ["espalda"],
      tip: "Mismo patrón que con barra pero con mayor rango; siente el estiramiento del isquiotibial al bajar." },
    { name: "Buenos días con barra", sub: "femoral_compound", pattern: "hinge", caution: ["espalda"],
  ...
  gluteo: [
    { name: "Hip thrust con barra", compound: true, pattern: "glute_bridge", caution: ["espalda"],
    ...
    { name: "Peso muerto rumano a una pierna con mancuerna", pattern: "hinge", caution: ["espalda", "cadera"],
  ...
  triceps: [
    ...
    { name: "Press cerrado en banco con barra", pattern: "press_horizontal", caution: ["hombro", "muñeca"],
  ...
  antebrazo: [
    ...
    { name: "Dead hang en barra de dominadas", pattern: "pull_vertical", caution: ["hombro"],
  ...
  abs: [
    ...
    { name: "Elevación de piernas en banco declinado", pattern: "core_crunch", caution: ["espalda"],
      tip: "Baja las piernas con control sin dejar que la zona lumbar se despegue del banco." },
    { name: "Elevación de rodillas en silla de ejercicios", pattern: "core_crunch", caution: ["hombro"],
    ...
    { name: "Plancha (plank)", pattern: "core_plank", caution: ["muñeca"],
    ...
    { name: "Rueda abdominal (ab wheel)", pattern: "core_plank", caution: ["espalda"],
      tip: "Abdomen apretado en todo el recorrido para proteger la zona lumbar." },
    { name: "Russian twist con disco", pattern: "core_crunch", caution: ["espalda"],
      tip: "Gira desde el torso, no solo los brazos; pies elevados para mayor dificultad." },
    { name: "Mountain climbers", impact: "high", pattern: "core_plank", caution: ["muñeca"],
  ...
  cardio: [
    ...
    { name: "Burpees", impact: "high", pattern: "jump", caution: ["rodilla", "muñeca"],
      tip: "Prioriza la técnica sobre la velocidad; aterriza suave en cada salto." },
    { name: "Jumping jacks", impact: "high", pattern: "jump", caution: ["rodilla"],
